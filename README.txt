Program Description:
The RideShare projectsimulates a 31-mile length of road with stations located at each mile.
...
If the passenger reaches its destination, it is dropped off.
...
Based on these results, we can conclude that configuration A results in higher revenue per driver.
...
that interact with each other. By breaking down the project into smaller chunks and tying them together at the end,
