 ...
 * Tracks the total revenue earned and miles driven
...
public class Road{
     ...
     * For the loop that starts from the first station, cars are moved in the negative direction
     * For the loop that starts from the last station, cars are moved in the positive direction
     * For each station, a loop iterates through each car
     * If the direction of the car corresponds to the loop and the car isn't at its destination:
     * Revenue is increased by the number of passengers in the car
     * Miles driven is incremented
     * The car is added to the next station
     * The car is removed from the current station
    ...
    /**
     * Getter method for the miles driven
